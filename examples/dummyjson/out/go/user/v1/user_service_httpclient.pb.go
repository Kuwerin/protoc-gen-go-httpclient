...
// Lists users.
func (h *httpClient) ListUsers(ctx context.Context, in *ListUsersRequest) (*ListUsersResponse, error) {
	var response ListUsersResponse

	var urlBuilder strings.Builder
	urlBuilder.WriteString(h.reqURL)
	urlBuilder.WriteString("/users")
	...
	urlBuilder.WriteString("skip")
	urlBuilder.WriteString(strconv.Itoa(int(in.Skip)))
	urlBuilder.WriteRune('&')
